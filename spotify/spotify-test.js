...
describe('Spotify collections', function () {
  it('should create a collection', function () {
    var chillHits = createCollection(
      'Chill Hits',
      'A collection of relaxing songs'
    );
  ...
  it('should add one track to a collection', function () {
    ...
    console.log(chillHitsWith1Track);
  ...
  it.only('should calculate the total duration of a collection', function () {
    var chillHits = createCollection(
      'Chill Hits',
      'A collection of relaxing songs'
    );
    ...
    var chillHitsWith1Track = addTrack(chillHits, track1);
    var chillHitsWith2Track = addTrack(chillHitsWith1Track, track2);
    console.log(chillHitsWith2Track);
  ...
  it.skip('should find tracks by artist in a collection', function () {
    ...
    assert.deepEqual(findTracksByArtist(chillHitsWith3Track, 'The Midnight'), [
      track1,
      track3,
    ]);
  });
